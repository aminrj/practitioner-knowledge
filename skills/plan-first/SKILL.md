...
version: 1.0.0
description: >-
  Structured planning workflow for any coding task. Use at the start of every
  new feature, bug fix, refactor, or implementation request. Analyzes the
  project, asks up to 5 clarifying questions, creates a TODO.md, gets user
  approval, then executes task by task. Never writes code before a plan is
  approved.
allowed-tools:
  - Read
  - Write
...
Workflow by u/SoAp9035 via r/LocalLLaMA
